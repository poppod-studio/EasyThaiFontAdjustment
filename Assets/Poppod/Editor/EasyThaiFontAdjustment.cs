// Assets/Poppod/Editor/EasyThaiFontAdjustment.cs
...
#if UNITY_6000_0_OR_NEWER || UGUI_2_0_OR_NEWER
...
ย่ำ ถ้ำ ฎุ ฎูำ";
        ...
        void RefreshTextMeshProComponents(TMP_FontAsset fontAsset)
        {
            ...
            // Unity 6+: FindObjectsSortMode is deprecated; use the no-sort-mode overload.
            var tmpTexts = Object.FindObjectsByType<TMP_Text>(FindObjectsInactive.Exclude);
